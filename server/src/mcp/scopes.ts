...
export const SCOPE_INFO: Record<Scope, ScopeInfo> = {
  ...
  'files:read':          { label: 'View trip files',            description: 'List trip documents and their reservation/place links',                 group: 'Files' },
  'files:write':         { label: 'Manage trip files',          description: 'Upload files and manage their description and reservation/place links',  group: 'Files' },
  'files:delete':        { label: 'Delete trip files',          description: 'Move trip files to the trash',                                          group: 'Files' },
